...
using namespace std; // this is for adding namespace
//Global Variables
char ans = 0;
int b, valid = 0;
void Title(void);
        ...
        sahu:
            ...
            case 1:
                while (!file1.eof())
                {
                    ...
                    {
                        cout << endl
                             << "\t\t\t\t\t\t\tEnter the new User-id(10-digit phone no)  :   ";
                        cin >> userid;
                        file << endl
                             << userid << "\t" << first << "\t" << last << "\t" << password << "\t" << gender << "\t" << eaddress;
